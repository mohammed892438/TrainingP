...
<div class="container mt-5">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h4>Add Volunteering Opportunity</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('volunteerings.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="mounthly_hours" class="form-control" id="mounthly_hours" required>
                </div>
